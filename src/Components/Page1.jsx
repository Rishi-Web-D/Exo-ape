  ...
  return (
    <div className="w-full h-[250vh] sm:h-[160vh] lg:h-[160vh]  relative overflow-hidden bg-zinc-900">
      ...
      <div className="sm:ml-2 sm:top-[48vh] lg:top-[45vh] container h-full w-[80%] absolute top-[17%] left-0  ml-24 text-white font-[TWK Lausanne-300]">
            ...
            return (
              <div className="masker ">
                <motion.h1
                  ...
                  className="sm:text-[12vh] lg:text-[10vh]  text-[10vmax]  leading-none tracking-tighter font-regular origin-top-left"
                >
                  {i}
                </motion.h1>
              </div>
        ...
        <div className="sm:bottom-[120vw] sm:w-[85%] lg:w-[65%] sm:-right-[10vh] sm:h-[38vh] z-50 right w-1/2 h-[25vmax] sm:px-4 px-9 py-5 absolute bottom-[28vmax] -right-[7vmax] lg:bottom-[60vh] lg:-right-[5vw]">
          <h3 className="font-semibold sm:text-[5vw] lg:text-[2vh] sm:leading-[2.5vh] lg:leading-8 text-[1.5vw] leading-[2.2vw] lg:">
